...
import com.forlost.sunflower.ui.chatkit.commons.models.MessageContentType;
import com.forlost.sunflower.ui.chatkit.utils.DateFormatter;
import com.forlost.sunflower.ui.chatkit.utils.RoundedImageView;
...
public class MessageHolders {
    ...
    protected void bind(final ViewHolder holder, final Object item, boolean isSelected,
                        ...
                        final SparseArray<MyMessagesListAdapter.OnMessageViewClickListener> clickListenersArray) {
    ...
    protected int getViewType(Object item, int dialogType, String dialogId) {
        ...
        if (item instanceof Message) {
            ...
            isOutcoming=false;
//            isOutcoming = message.getSendUser().uid.contentEquals(dialogId);
    ...
    public static abstract class BaseMessageViewHolder<MESSAGE extends IMessage> extends ViewHolder<MESSAGE> {
        ...
        public boolean isSelectionModeEnabled() {
            return MyMessagesListAdapter.isSelectionModeEnabled;
        }
        ...
        protected void configureLinksBehavior(final TextView text) {
            ...
            text.setMovementMethod(new LinkMovementMethod() {
                ...
                public boolean onTouchEvent(TextView widget, Spannable buffer, MotionEvent event) {
                    ...
                    if (!MyMessagesListAdapter.isSelectionModeEnabled) {
