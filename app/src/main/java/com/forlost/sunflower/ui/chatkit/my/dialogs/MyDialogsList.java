 ...
 */
public class MyDialogsList extends RecyclerView {

    private DialogListStyle dialogStyle;

    public MyDialogsList(Context context) {
        super(context);
    }

    public MyDialogsList(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        parseStyle(context, attrs);
    }

    public MyDialogsList(Context context, @Nullable AttributeSet attrs, int defStyle) {
     ...
     * Call {@link #setAdapter(MyDialogsListAdapter)} instead.
     */
    @Override
     ...
     */
    public void setAdapter(MyDialogsListAdapter adapter) {
     ...
     */
    public void setAdapter(MyDialogsListAdapter adapter, boolean reverseLayout) {
